...
@Transactional
public class CreateAuditorServiceTest extends AbstractTest {
	...
	public void driverCreateAuditor() {
		...
		for (int i = 0; i < testingData.length; i++)
			this.templateCreateAuditor((String) testingData[i][0], (String) testingData[i][1], (String) testingData[i][2], (String) testingData[i][3], (Long) testingData[i][4], (Integer) testingData[i][5], (Integer) testingData[i][6],
	...
	private void templateCreateAuditor(String name, String surname, String VAT, String holderName, Long number, Integer month, Integer year, Integer CVV, String cardType, String photo, String email, String phone, String address, String username,
		...
		try {
			...
			Auditor auditor = this.auditorService.createAuditor();
