...
<%@taglib prefix="acme"  tagdir="/WEB-INF/tags"%>
	...
	<display:table name="providers" id="row" pagesize="5" class="displaytag">
		...
		<display:column property="make" titleKey="?" sortable="true"/> 
