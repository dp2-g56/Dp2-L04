...
<security:authorize access="hasRole('ROOKIE')">
	...
	<form action="miscellaneousData/rookie/saveAttachment.do" name="createAttachment" id="createAttachment" method="post">
		...
		<acme:cancel url="/miscellaneousData/rookie/listAttachments.do?miscellaneousDataId=${miscellaneousDataId}" code="curriculum.cancelButton" /> 
