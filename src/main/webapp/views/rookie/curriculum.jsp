...
<%@taglib prefix="acme"  tagdir="/WEB-INF/tags"%>
	...
	<display:table name="miscellaneousData" id="row" pagesize="5" class="displaytag" 
		...
		<display:column titleKey="miscellaneousData.action">
			<spring:url var="attachments" value="/miscellaneousData/rookie/listAttachments.do">
				<spring:param name="miscellaneousDataId" value="${row.id}"/>
			</spring:url>
			<security:authorize access="hasRole('ROOKIE')">
				<spring:url var="editMiscellaneousData" value="/miscellaneousData/rookie/edit.do">
					<spring:param name="miscellaneousDataId" value="${row.id}"/>
				</spring:url>
				<spring:url var="deleteMiscellaneousData" value="/miscellaneousData/rookie/delete.do">
					<spring:param name="miscellaneousDataId" value="${row.id}"/>
				</spring:url>
			</security:authorize>
			<a href="${attachments}">
			...
			</a><security:authorize access="hasRole('ROOKIE')"> / 
