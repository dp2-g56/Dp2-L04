...
<script type="text/javascript">
  ...
  if(res == false && phoneNumber != "") {
	...
	<security:authorize access = "hasRole('AUDITOR')">
		<form:form modelAttribute="formObjectEditAuditor" action="authenticated/auditor/edit.do">
	...
	<security:authorize access = "hasRole('PROVIDER')">
		<form:form modelAttribute="formObjectEditProvider" action="authenticated/provider/edit.do">
		...
		<acme:input path="make" code="anonymous.make" />
		<br />	
